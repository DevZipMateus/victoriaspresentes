      ...
      <div className="container mx-auto relative">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <div className="flex items-center justify-center space-x-4 animate-on-scroll">
            ...
            >
              <span 
                className={`absolute top-1 w-5 h-5 rounded-full bg-primary transition-transform duration-300 transform ${
                  yearlySub ? 'translate-x-7' : 'translate-x-0'
                }`}
              ></span>
            </button>
...
const PlanCard = ({ name, description, price, features, popular, cta, index }: PlanCardProps) => (
  <Card 
    className={`animate-on-scroll service-card relative overflow-hidden border border-border/50 ${
      popular ? 'shadow-lg scale-105 border-primary/20 z-10' : 'shadow-card z-0'
