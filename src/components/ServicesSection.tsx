...
const ServiceCard = ({
  ...
  description,
  index
}: ServiceCardProps) => <Card className={`animate-on-scroll service-card border border-border/50 shadow-card overflow-hidden h-full [animation-delay:${index * 100}ms]`}>
