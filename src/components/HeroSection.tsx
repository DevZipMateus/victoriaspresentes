  ...
  return <section id="hero" ref={sectionRef} className="relative min-h-screen flex items-center justify-center pt-16">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-white/95 font-medium mb-6 animate-slide-up [animation-delay:300ms]">
          ...
          <p className="text-lg md:text-xl text-white/95 mb-8 max-w-2xl mx-auto animate-slide-up [animation-delay:700ms]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up [animation-delay:900ms]">
            <Button size="lg" className="bg-white text-primary hover:bg-white/95 rounded-md shadow-md transition-all duration-300">
              Saiba Mais
            </Button>
            <Button size="lg" variant="outline" className="quote-btn border-white hover:border-white hover:bg-white/10 group rounded-md shadow-md transition-all duration-300 flex gap-2 text-white">
